export default {
  ru: {
    expenses: {
      ...
      taxCopyCsv: 'Скопировать CSV',
      taxCopied: 'Скопировано',
      taxCopyHint: 'На телефоне файл не сохранить — CSV копируется в буфер, вставьте его в письмо.',
      taxCopyFailed: 'Буфер обмена недоступен.',
      until: 'до {{month}}',
  ...
  en: {
    expenses: {
      ...
      taxCopyCsv: 'Copy CSV',
      taxCopied: 'Copied',
      taxCopyHint: 'Saving a file isn’t possible on the phone — the CSV is copied to the clipboard.',
      taxCopyFailed: 'Clipboard is not available.',
      until: 'until {{month}}',
